...
export JUPYTER_NOTEBOOK_VENV="${JUPYTER_NOTEBOOK_VENV:-$JUPYTER_NOTEBOOK_VENV}"
export JUPYTER_NOTEBOOK_DIR="${JUPYTER_NOTEBOOK_DIR:-$JUPYTER_NOTEBOOK_DIR}"
export JUPYTER_NOTEBOOK_IP="${JUPYTER_NOTEBOOK_IP:-$JUPYTER_NOTEBOOK_IP}"
